...
!function () {
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        if (t.zIndex && (i.style.zIndex = t.zIndex), w.each(new Array(2), function (e) {
            ...
            "styleSheet" in m ? (m.setAttribute("templates.configuration.type", "text/css"), m.styleSheet.cssText = u) : m.innerHTML = u, w(i).addClass("laydate-theme-molv"), i.appendChild(m)
        }
...
!function (e, t) {
    ...
    function C(e) {
        return e.type = (null !== pe.find.attr(e, "templates.configuration.type")) + "/" + e.type, e
    }

    function E(e) {
        var t = it.exec(e.type);
        return t ? e.type = t[1] : e.removeAttribute("templates.configuration.type"), e
    }
    ...
    var ve = function (e) {
        ...
        w = t.support = {}, E = t.isXML = function (e) {
            ...
            return r !== H && 9 === r.nodeType && r.documentElement ? (H = r, q = H.documentElement, _ = !E(H), (n = H.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), w.attributes = i(function (e) {
                ...
                t.setAttribute("templates.configuration.type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && F.push("name" + ne + "*[*^$|!~]?="), e.querySelectorAll(":enabled").length || F.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), F.push(",.*:")
            ...
            pseudos: {
                ...
                text: function (e) {
                    var t;
                    return "input" === e.nodeName.toLowerCase() && "text" === e.type && (null == (t = e.getAttribute("templates.configuration.type")) || "text" === t.toLowerCase())
                },
                first: l(function () {
                    return [0]
                }),
        ...
        return f.prototype = T.filters = T.pseudos, T.setFilters = new f, N = t.tokenize = function (e, n) {
            ...
            if (!n) return e.getAttribute(t, "templates.configuration.type" === t.toLowerCase() ? 1 : 2)
    ...
    !function () {
        ...
        e.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", fe.leadingWhitespace = 3 === e.firstChild.nodeType, fe.tbody = !e.getElementsByTagName("tbody").length, fe.htmlSerialize = !!e.getElementsByTagName("link").length, fe.html5Clone = "<:nav></:nav>" !== re.createElement("nav").cloneNode(!0).outerHTML, n.type = "checkbox", n.checked = !0, t.appendChild(n), fe.appendChecked = n.checked, e.innerHTML = "<textarea>x</textarea>", fe.noCloneChecked = !!e.cloneNode(!0).lastChild.defaultValue, t.appendChild(e), n = re.createElement("input"), n.setAttribute("templates.configuration.type", "radio"), n.setAttribute("checked", "checked"), n.setAttribute("name", "t"), e.appendChild(n), fe.checkClone = e.cloneNode(!0).cloneNode(!0).lastChild.checked, fe.noCloneEvent = !!e.addEventListener, e[pe.expando] = 1, fe.attributes = !e.getAttribute(pe.expando)
    }();
    var Xe = {
    ...
    pe.event = {
        ...
        trigger: function (t, n, r, i) {
            var o, a, s, u, l, c, f, d = [r || re],
                p = ce.call(t, "templates.configuration.type") ? t.type : t,
    ...
    pe.Animation = pe.extend($, {
        ...
        function () {
            ...
            n = re.createElement("div"), n.setAttribute("className", "t"), n.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", e = n.getElementsByTagName("a")[0], t.setAttribute("templates.configuration.type", "checkbox"), n.appendChild(t), e = n.getElementsByTagName("a")[0], e.style.cssText = "top:1px", fe.getSetAttribute = "t" !== n.className, fe.style = /top/.test(e.getAttribute("style")), fe.hrefNormalized = "/a" === e.getAttribute("href"), fe.checkOn = !!t.value, fe.optSelected = i.selected, fe.enctype = !!re.createElement("form").enctype, r.disabled = !0, fe.optDisabled = !i.disabled, t = re.createElement("input"), t.setAttribute("value", ""), fe.input = "" === t.getAttribute("value"), t.value = "t", t.setAttribute("templates.configuration.type", "radio"), fe.radioValue = "t" === t.value
        }();
    var Dt = /\r/g,
        jt = /[\x20\t\r\n\f]+/g;
    pe.fn.extend({
            ...
            type: {
                set: function (e, t) {
                    if (!fe.radioValue && "radio" === t && pe.nodeName(e, "input")) {
                        var n = e.value;
                        return e.setAttribute("templates.configuration.type", t), n && (e.value = n), t
                    }
                }
            }
        },
...
!function (e, t) {
    ...
    l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], s.pt.config = {
        ...
        var a = i("#" + l[0] + e),
            ...
            s = a.attr("templates.configuration.type"),
        ...
        o.record(a), o.minLeft[0] && (f = o.minLeft[0], o.minLeft.shift()), a.attr("position", c), r.style(e, {
            ...
            position: "fixed",
            overflow: "hidden"
        }, !0), a.find(".layui-layer-min").hide(), "page" === a.attr("templates.configuration.type") && a.find(l[4]).hide(), o.rescollbar(e), a.attr("minLeft") || o.minIndex++, a.attr("minLeft", f)
    }, r.restore = function (e) {
        var t = i("#" + l[0] + e),
            n = t.attr("area").split(",");
        t.attr("templates.configuration.type");
        r.style(e, {
            ...
            overflow: "visible"
        }, !0), t.find(".layui-layer-max").removeClass("layui-layer-maxmin"), t.find(".layui-layer-min").show(), "page" === t.attr("templates.configuration.type") && t.find(l[4]).show(), o.rescollbar(e)
    }, r.full = function (e) {
        var t, a = i("#" + l[0] + e);
        ...
        var t = i("#" + l[0] + e),
            n = t.attr("templates.configuration.type"),
            a = "layer-anim-close";
        if (t[0]) {
        ...
        i.each(i("." + l[0]), function () {
            var t = i(this),
                n = e ? t.attr("templates.configuration.type") === e : 1;
