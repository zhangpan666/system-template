...
public class MD5Util {
    ...
    public final static String MD5(String inputStr) {
        ...
        try {
            ...
            byte[] btInput = inputStr.getBytes(StandardCharsets.UTF_8);
    ...
    public static String getMD5EncodeString(Object... param) {
        StringBuilder stringBuilder = new StringBuilder();
        for (Object o : param) {
            stringBuilder.append(o.toString());
        }
        return MD5Encode(stringBuilder.toString(), "UTF-8");
    }

    public static String getMD5EncodeString(Map<String, Object> param) {
        StringBuilder stringBuilder = new StringBuilder();
        ...
        return MD5Encode(string, "UTF-8").toLowerCase();
    }
